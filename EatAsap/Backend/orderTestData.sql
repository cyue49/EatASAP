...
(1, 'John', 'Doe', 'john@example.com', 'password123', '1234567890', 'owner'),
(2, 'Jane', 'Doe', 'jane@example.com', 'password456', '0987654321', 'owner'),
(3, 'Alice', 'Smith', 'alice@example.com', 'password789', '5551234567', 'owner'),
(4, 'Bob', 'Johnson', 'bob@example.com', 'passwordabc', '9876543210', 'owner'),
(5, 'Eve', 'Brown', 'eve@example.com', 'passwordxyz', '1112223333', 'customer');
